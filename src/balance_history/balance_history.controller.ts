...
export class BalanceHistoryController {
  ...
  // @ApiOperation({ summary: 'Create a Balance History' })
  // @Post()
  // async create(@Body() createBalanceHistoryDto: CreateBalanceHistoryDto) {
  //   return this.balanceHistoryService.create(createBalanceHistoryDto);
  // }
